...
interface Exam { id: string; name: string; subject: string; cat: string; date: string; desc: string; links: Lnk[]; max: number; got: number; pct: number; grade: string; answer: string; ai: string; created: string; }
